...
function SideNav() {
  ...
  return (
    <div>
        <div className='grid grid-cols-1 justify-start bg-white dark:bg-slate-800 border-r dark:border-slate-700 p-6 w-1/2 h-[calc(100vh-71px)] z-20 fixed -left-96 lg:w-64 lg:left-0 peer-focus:left-0 peer:transition ease-out delay-150 duration-200'>
